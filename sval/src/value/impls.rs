...
mod tests {
    ...
    mod std_support {
        ...
        fn stream_rc() {
            assert_eq!(
                vec![Kind::Signed(1)],
                test::tokens(Rc::new(1i8)));
            
            assert_eq!(
                vec![Kind::Signed(1)],
                test::tokens(Arc::new(1i8)));
        }
    }
}
